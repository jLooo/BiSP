...
def Eval(model=None):
    ...
    parser.add_argument('--model_dir', type=str, default='./modelzoo/best_model_ped2.pth', help='directory of model')
    ...
    if args.dataset_type == 'ped1' or args.dataset_type == 'ped2':
        format = '*.tif'
    else:
        format = '*.jpg'
    ...
    # np.save('./data/psnr/ped2/{}_{}.npy'.format(args.dataset_type, str(accuracy)), psnr_multi_list)
